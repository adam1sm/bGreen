      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white tracking-tight">
            ...
            <span className="text-emerald-600 dark:text-emerald-400">every dollar spent</span>
          </h1>
          
          <p className="mt-6 text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Greenline turns your spending into CO₂e estimates you can test, tune, and improve.
          </p>
          
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => scrollToSection('experiment')}
              className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 shadow-lg hover:shadow-xl"
            >
              Start experimenting
            </button>
            ...
            <button
              ...
              className="text-gray-700 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 px-8 py-4 rounded-xl text-lg font-semibold border-2 border-gray-300 dark:border-gray-600 hover:border-emerald-300 dark:hover:border-emerald-600 transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
            >
              See how it works
            </button>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
              <div className="text-2xl font-bold text-gray-400 dark:text-gray-500">Stripe</div>
              <div className="text-2xl font-bold text-gray-400 dark:text-gray-500">•</div>
              <div className="text-2xl font-bold text-gray-400 dark:text-gray-500">EEIO</div>
              <div className="text-2xl font-bold text-gray-400 dark:text-gray-500">•</div>
              <div className="text-2xl font-bold text-gray-400 dark:text-gray-500">MCC</div>
            </div>
          </div>
        </div>
      </div>
